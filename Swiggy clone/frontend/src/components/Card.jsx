    ...
    return (
        <div className={`${props.width} shrink-0 mb-3`}>
            <div className='group h-[182px] rounded-[15px] overflow-hidden relative'>
                <img className='group-hover:scale-110 duration-150 object-cover w-full h-full' src={"http://localhost:5000/images/" + props.image} alt={props.title} />
...
// Renamed Start to Star for better naming convention
const Star = (props) => {
    return (
        <svg
        ...
        >
            <circle
                ...
                cy={10}
                r={9}
                fill="url(#StarRating20_svg__paint0_linear_32982_71567)"
            />
            <path
            ...
            <defs>
                <linearGradient
                    id="StarRating20_svg__paint0_linear_32982_71567"
                    x1={10}
                    y1={1}
                    x2={10}
                    y2={19}
